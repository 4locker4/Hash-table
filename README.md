...
Для теста нашей хеш-таблицы был взят текст Льва Толского "Война и мир", содержащий примерно 680 тысяч слов. Однако уникальных примерно 15 тысяч, если не брать в рассчет регистр. Однако данная хеш-таблицы - регистро-зависимая. Поэтому размер хеш-таблицы примем равным 1000.
...
Для сбора данных профилирующими программами функция поиска элементов хеш-таблицы будет вызвана 100 000 000 раз.
...
**Прирост к производительности составил 27%
**
### | Оптимизация strcmp ()
...
Как мы можем видеть, прирост составил всего 2%. Следовательно, оптимизация прошла безуспешно. 
...
В данной работе произведены оптимизации над *функцией хеширования* и *strcmp ()*. 